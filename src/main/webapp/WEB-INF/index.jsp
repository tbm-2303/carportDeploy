    ...
    <jsp:body>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="${pageContext.request.contextPath}/fc/standardcarportpage">STANDARD CARPORTE</a>
                <a href="${pageContext.request.contextPath}/fc/sendrequestpage">CARPORT EFTER EGNE MÅL</a>
            </div>
        </div>
